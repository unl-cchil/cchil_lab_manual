...
* To set times I usually use the _Set custom hours_ option.
  ...
  - All avialability is automatically recurring on a weekly basis unless otherwise stated.
  - To change avilablity on individual days (non-recurring changes), click on the _Add a date override_ button to the right. Then select on the day you want to customize the times for.
