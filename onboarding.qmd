...
2. Install Microsoft Teams on your phone and computer and log in via your UNL credentials.
3. Go to the [IACUC training page](https://research.unl.edu/researchresponsibility/required-and-optional-training-2/) to:
    a. Complete online CITI IACUC training (**Working with the IACUC- Investigators, Staff, and Students- 1 Basic Course**) and send Jeff a PDF of the certification when completed.
...
5. Send Jeff your NUID for lab keycard access.
6. Read over the lab manual.
